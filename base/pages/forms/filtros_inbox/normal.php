...
<table  class="table table-head-fixed text-nowrap" name="table">
                  <tbody>
                         ...
                         //  echo $consulta;
                          ...
                          and ti.us_id='".$id."' and catu.estado='ACTIVO' and ti.tic_estado='ACTIVO' and ti.tk_nivel='NORMAL' group by  ti.tickes_id";
                        ...
                        // USUARIO BASE SIN PERMISOS
                         ...
                         and catu.estado='ACTIVO' and ti.tic_estado='ACTIVO'  and ti.tk_nivel='NORMAL' group by  ti.tickes_id";
                           //echo $sql;
