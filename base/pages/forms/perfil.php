          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
               ...
               <!-- <p class="text-muted text-center">Titulo  academico <a href="#"><i class="fas fa-pencil-alt mr-1"></i></a></p> -->
                <a href="cambio_pass.php" class="btn btn-primary btn-block"><b>Cambio de contraseña</b></a>
                <a href="logout.php" class="btn btn-primary btn-block"><b>Cerrar Session</b></a>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
