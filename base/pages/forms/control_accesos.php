...
<?php
      //MANEJO DEL ESTADO DE LOS USUARIOS 
        ...
        {  
          $sql="UPDATE `bd_local`.`tbl_acceso` SET `acc_estado` = 'INACTIVO' WHERE (`acc_id` = '".$_POST["cc"]."');
          ";
        //echo " el sql    ".$sql;
       ...
       //  echo "<script>alert('".$_POST['cc']."');</script>";
        ...
        if($accion=='habilitar')
        {
          ...
          $sql="UPDATE `bd_local`.`tbl_acceso` SET `acc_estado` = 'ACTIVO' WHERE (`acc_id` = '".$_POST["cc"]."');";
        // echo " el sql    ".$sql;
     $result=mysqli_query($conexion,$sql);
 ...
 <div class="content-wrapper">
   <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Control de creacion de accesos</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="inicio.php">Inicio</a></li>
              <li class="breadcrumb-item active">Control de creacion de accesos</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <tbody>
                    <?php 
                    $sql="SELECT acc_id as id,acc_nombre as nombre, acc_estado as estado FROM bd_local.tbl_acceso ";
                    $result=mysqli_query($conexion,$sql);
